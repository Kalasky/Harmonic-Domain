  ...
  return (
    <Popover className={`relative ${isSticky ? 'max-md:sticky top-0 z-50 glass-overlay sm:bg-transparent' : 'bg-transparent'}`}>
      {({ open, close }) => (
        ...
        (
          <>
            <div className="container mx-auto sm:py-8 mb-20">
              <div className="flex max-md:justify-between items-center border-b-2 border-none py-6 md:space-x-10">
                ...
                <div className="hidden md:flex items-center space-x-10 ml-auto">
                  <GlowGrayPrimary
                    ...
                    padding={'px-4 py-2'}
                  >
                    <FontAwesomeIcon icon={faSpotify} size='lg' className="mr-2 text-pink-400" />
                    Spotify
                  </GlowGrayPrimary>
                </div>
                <div className="flex xl:hidden items-center ml-4">
                  <Popover.Button
                    ...
                    className={classNames(
                      ...
                      'rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-pink-400'
                    )}
                  >
            ...
            <Transition.Root show={open} as={Fragment}>
              <div className="xl:hidden">
                ...
                <Transition.Child
                  ...
                  enterFrom="opacity-0 rotate-[-10deg] scale-400"
                  enterTo="opacity-100 rotate-0 scale-100"
                  leave="transform duration-200 transition ease-in-out"
                  leaveFrom="opacity-100 rotate-100 scale-100"
                ...
                >
                  ...
                  >
                    <div
                      className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 divide-y-2 divide-gray-700 overflow-y-auto max-h-screen"
                      style={{ backgroundColor: 'rgb(29 29 29 / var(--tw-bg-opacity))' }}
                    >
                          ...
                          <div className="-mr-2">
                            <Popover.Button
                              ...
                              className={classNames(
                                ...
                                'rounded-md p-2 inline-flex items-center justify-center text-gray-300 hover:text-pink-400'
                              )}
                            >
                          ...
                          <nav className="grid gap-y-8">
                            ...
                            {social.map((item) => (
                              <Link key={item.name} to={item.href} className="-m-3 p-3 flex items-center rounded-md">
                                <FontAwesomeIcon icon={item.icon} className="h-4 text-pink-400" /> <span className="ml-3"></span>
                                <span className="ml-3 text-base font-medium text-white hover:text-pink-200">{item.name}</span>
                              </Link>
                            ))}
                          </nav>
                        </div>
